...
if opts.KatFileObsReporter and product_metadata:
    ...
    xmlrpc_client.workflowmgr.handleEvent('KatFileObsReporter', product_metadata, queue='manual')
...
if opts.RTSTelescopeProductObsReporter and product_metadata:
    ...
    xmlrpc_client.workflowmgr.handleEvent('RTSTelescopeProductObsReporter', product_metadata, queue='manual')
...
if opts.KatFileImagerPipeline and product_metadata:
    ...
    xmlrpc_client.workflowmgr.handleEvent('KatFileImagerPipeline', product_metadata, queue='manual')
...
if opts.KatFileRTSTesting and product_metadata:
    ...
    xmlrpc_client.workflowmgr.handleEvent('KatFileRTSTesting', product_metadata, queue='manual')

if opts.MeerkatTelescopeTapeProductCheckArchiveToTape and product_metadata:
    product_metadata['ReductionName'] = product_metadata['Description']
    logging.info('Calling handleEvent KatFileRTSTesting with product %s with reductions %s' % (product_metadata['ReductionName'][0]))
    xmlrpc_client.workflowmgr.handleEvent('MeerkatTelescopeTapeProductCheckArchiveToTape', product_metadata, queue='manual')
...
if opts.RTSTelescopeProductReduce and product_metadata and opts.ReductionName:
    ...
    xmlrpc_client.workflowmgr.handleEvent('RTSTelescopeProductReduce', product_metadata, queue='manual')
