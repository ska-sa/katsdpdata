...
class NoSuchProductException(Exception):
    """Exception to handle when product does not exist"""
...
class MetaDataHandler(object):
    ...
    def get_transfer_status(self, product_id):
        met = self.get_prod_met(product_id)
        return met['CAS.ProductTransferStatus']
    ...
    def get_prod_met(self, prod_id):
        ...
        if res.hits == 0 or res.hits > 1:
            raise NoSuchProductException('No such product {}'.format(prod_id))
        elif res.hits > 1:
