...
#SOLR_CORE = 'http://kat-archive.kat.ac.za:8983/solr/kat_core'
SOLR_CORE = 'http://cms3.sdp.mkat.chpc.kat.ac.za:8983/solr/kat_core'
...
class MetaDataHandler(object):
    ...
    """
    def __init__(self, product_type, product_name, product_id=None):
        super(MetaDataHandler, self).__init__()
        self.solr_core = SOLR_CORE
        self.solr = pysolr.Solr(self.solr_core)
