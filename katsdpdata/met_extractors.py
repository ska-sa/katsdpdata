...
class TelescopeProductMetExtractor(MetExtractor):
    ...
    def _extract_metadata_from_katdata(self):
        ...
        self.metadata['CenterFrequency'] = str(self._katdata.channel_freqs[int(len(self._katdata.channel_freqs)/2)])
        ...
        self.metadata['StartTime'] = time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime(float(self._katdata.start_time)))
